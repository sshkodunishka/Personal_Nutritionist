...
{
    public class AddMealProduct : CommandBase
    {
        private readonly ViewModels.AddMealProduct _viewModel;
        private readonly PersonalNavigationStore _personalNavigationStore;

        public AddMealProduct(ViewModels.AddMealProduct viewModel, PersonalNavigationStore personalNavigationStore)
        {
        ...
        public override void Execute(object parameter)
        {
            try
            {
                ...
                MealFood food = new MealFood(_viewModel.SelectedProduct.ProductId, history.MealHistoryId, false);
