...
{
    public class UserAddRecipe : CommandBase
    {
        private readonly UserAddRecipeViewModel _viewModel;
        private readonly PersonalNavigationStore _personalNavigationStore;

        public UserAddRecipe(UserAddRecipeViewModel viewModel, PersonalNavigationStore personalNavigationStore)
        {
        ...
        public override void Execute(object parameter)
        {
            try
            {
                ...
                _personalNavigationStore.CurrentPersonalViewModel = new UserRecipeViewModel(_personalNavigationStore);
            }
            catch
            {
